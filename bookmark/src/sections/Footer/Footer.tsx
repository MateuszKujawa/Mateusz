...
const Footer = () => {
  return (
    <>
      <footer className="bg-darkblue-secondary py-6 md:py-4">
        <div className="container max-w-7xl flex flex-col items-center justify-between mx-auto space-y-10 px-6 md:flex-row md:space-y-0">
          <div className="flex flex-col items-center justify-between space-y-6 text-lg font-base md:flex-row md:space-y-0 md:space-x-14">
            <a href="/">
            ...
            <a
              href="#features"
              className="text-gray-secondary uppercase hover:text-red-primary"
            >
              Features
            </a>
            <a
